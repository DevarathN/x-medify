...
const AppPromotion = () => {
  return (
    <div className="AppPromotion-container">
      <div className="AppPromotionImages">
        {" "}
        <div className="imageGroup">
          <img className="mobileScreen" src={MobileScreen} alt="" srcset="" />
          <img className="mobileCover" src={MobileCover} alt="" srcset="" />
        </div>
        <div className="imageGroup">
          <img className="mobileScreen" src={MobileScreen} alt="" srcset="" />
          <img className="mobileCover" src={MobileCover} alt="" srcset="" />
      ...
      <div className="AppPromotionText">
        <svg
          width="49"
          height="111"
          viewBox="0 0 49 111"
        ...
        <div>
          <h2> Download the </h2>
          <h2>
            <span style={{ color: "#2AA7FF" }}>Medify</span>
            <span>App</span>
          </h2>{" "}
        </div>

        <p>Get the link to download the app</p>
        <div className="phoneNumber-SMS">
          <div className="phoneNumber">
            <span style={{ fontFamily: "Lato,sans-serif", fontWeight: "600" }}>
              +91
            </span>
            <input type="text" name="" id="" placeholder="Enter phone number" />
          </div>
          <div>
            <button type="button" className="btn home-btns">
              Send SMS
            </button>
          </div>
        </div>
        <div className="appStore">
          <button type="button">
            <img src={GooglePlayStore} alt="" srcset="" />
          </button>
          <button type="button">
            <img src={ApplePlayStore} alt="" srcset="" />
          </button>
        </div>
      </div>
    </div>
